...
class CountdownsControllerTest < ActionController::TestCase
  ...
  test "should create countdown" do
    assert_difference('Countdown.count') do
      post :create, countdown: { countdown_date: @countdown.countdown_date, description: @countdown.description, name: @countdown.name }
    end
  ...
  test "should update countdown" do
    put :update, id: @countdown, countdown: { countdown_date: @countdown.countdown_date, description: @countdown.description, name: @countdown.name }
    assert_redirected_to countdown_path(assigns(:countdown))
  end
